...
varobstacle, obstacleImage;
var FoodGroup, obstacleGroup;
var score, survialTime;
var ground; var PLAY = 1;
var END = 0;
var gameState = PLAY;
...
Canvas=createCanvas(400,400);
 ...
 monkey = createSprite(50, 250, 10, 10); monkey.addAnimation("monkey",monkey_running);
 monkey.scale = 0.1;
...
monkey.velocityY = monkey.velocityY + 0.8; obstacleGroup.setLifetimeEach(-1);
    food();
    obstacles();
...
function food() {
  if (frameCount % 80 === 0) {
    banana = createSprite(400,350,40,10); banana.addImage(bananaImage); 
